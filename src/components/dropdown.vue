	...
	>
		...
		<div v-expand="isExpanded" class="options expand" v-if="type!=='sort'">
			<div
				...
				class="option"
				style="border: 5px solid #ffa034; margin: 5px; padding: 1px 8px!important;"
				@click="setCurrentSelectedOption({value:null});"
			>CLEAR</div>
			<div
