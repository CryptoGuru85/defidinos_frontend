                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-content-header">
                            <span v-bind:style="{ backgroundColor : pointsColor(getCurrentDino.points)}">{{getCurrentDino.points}}</span>
                            <h4>{{getCurrentDino.name}}</h4>
                        </div>
                        <div class="tag-list">
                          <div v-for="(attr) of getCurrentDino.attributes" :key="attr.id">
                            <div v-if="attr.task.trait_type !== 'Tier'" class="tag-list-item">
